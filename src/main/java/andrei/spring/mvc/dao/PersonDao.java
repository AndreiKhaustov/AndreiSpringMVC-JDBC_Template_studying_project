...
public void testMultipleUpdate() {
    ...
    people.forEach(person -> jdbcTemplate.update("INSERT INTO Person VALUES (?, ?, ?, ?)", person.getId(), person.getName(), person.getAge(), person.getEmail()));
    ...
    List<Person>people = new ArrayList<>();
        for (int i = 0; i < 1000; i++) {
            people.add(new Person(i, "Name"+ i, 28, "test"+i+"@mail.ru"));
        }
        return people;
    }
